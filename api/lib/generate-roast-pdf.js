...
function drawFooter(doc, pageNum) {
  ...
  doc
    ...
    .text("Generated by vibezap.dev/roast — AI Website Analysis", 50, y, {
      align: "center",
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      y = drawWrappedText(
        ...
        50,
        y,
        { fontSize: 10, lineGap: 5 }
      );

      // ── CATEGORY BREAKDOWN ──
      y = doc.y + 20;
      doc.y = y;
      ensureSpace(doc, 90, pageCounter);
      y = doc.y;
      ...
      for (const catName of catNames) {
        ...
        ensureSpace(doc, 70, pageCounter);
        y = doc.y;
        ...
        if (cat.comment) {
          doc
            ...
            .fillColor(COLORS.gray)
            .text(`"${sanitizeText(cat.comment)}"`, 50, y, { width: pageWidth, lineGap: 3 });
          y = doc.y + 6;
        }
      ...
      y = doc.y + 20;
      doc.y = y;
      ensureSpace(doc, 50, pageCounter);
      y = doc.y;
