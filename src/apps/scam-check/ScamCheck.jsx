...
export default function ScamCheck() {
  ...
  const checkoutUrlRef = useRef("https://vibezap.lemonsqueezy.com/checkout/buy/d96e2de1-52de-49aa-879b-693d33f1c60a");
  ...
  return (
    <>
      ...
      <div style={{
                    ...
                    <>
                      <div
                        style={{
                          ...
                          borderRadius: "50%",
                          animation: "scamSpin 0.8s linear infinite",
                        }}
                      />
                      <h3 style={{
                        fontFamily: "'Playfair Display', serif",
        ...
        {/* Legal disclaimer */}
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: 16, paddingTop: 10, textAlign: 'center', fontSize: 12, color: '#555', fontFamily: "'Outfit', sans-serif" }}>
